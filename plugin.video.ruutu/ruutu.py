...
class RuutuAddon(xbmcUtil.ViewAddonAbstract):
	...
	def handleMain(self, pg, args):
		...
		self.addViewLink(self.lang(30029), 'category', 1,
						 {'link': 'http://www.ruutu.fi/views_cacheable_pager/theme_liftups/block_8/Ruoka?page=0%2C0%2C0%2C0%2C0%2C0%2C0%2C0%2C0%2C0%2C0%2C', 'grouping': 'True'})
		...
		if items is not None:
			...
			for item in items:
				...
				self.addVideoLink(title, item['link'], item['image'],
								  infoLabels={'plot': plot, 'season': seasonNum, 'episode': episodeNum, 'aired': aired, 'duration': item['duration']}, contextMenu=contextMenu)
